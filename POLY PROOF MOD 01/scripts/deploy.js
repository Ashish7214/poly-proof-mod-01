...
// Asynchronous main function to deploy the Recipe contract
async function main() {
  // Get the contract factory (ABI and bytecode) using the contract name "Recipe"
  const NFT = await hre.ethers.getContractFactory("Recipe");
