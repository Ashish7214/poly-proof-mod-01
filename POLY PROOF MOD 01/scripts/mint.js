...
async function main() {
  ...
  const contractAddress = "0x4d6e96c4737fb3CE5250687705d33FB58afDD496";

  // Get the contract factory for the Recipe contract and attach it to the signer
  const OneNFT = await ethers.getContractFactory("Recipe", signer);
