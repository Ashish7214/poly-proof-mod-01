...
// Recipe contract that extends ERC721A
contract Recipe is ERC721A {
    ...
    string baseUrl =
        "https://gateway.pinata.cloud/ipfs/QmetRgPxaScdAnXn5uQwrqyd74wR5fe1DiocrGkYWBZcru/";

    // URL for the prompt description displayed to users
    string public prompt = "Enjoy the Taste";

    // Constructor to initialize the contract with a name and symbol for the NFTs
    constructor() ERC721A("Recipe", "RP") {
        owner = msg.sender;
    }
